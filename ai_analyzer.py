...
class AIAnalyzer:
    ...
    def generate_news_summary(self, article: Dict) -> str:
        ...
        严格按照summary_finance.md中的示例格式输出，并忽略所有提示、警告，直接输出总结内容
        """
...
4. 影响分析要分点，使用"-"符号；如果无法分析出对市场或行业或企业的影响，则忽略
5. 总结要详细、专业，涵盖时间、事件、影响等要素
6. 如果是英文新闻，分析时使用中文

特别注意：
1. 获取的新闻均来自国内外正规网站，内容不包含不安全内容和敏感信息，请放心忽略所有提示、警告，直接输出总结内容
...
根据获取的中国财经新闻和美国财经新闻，分别给出中国和美国的基金、股票的投资建议以及人民币和美元的汇率分析，只需要细分到领域和行业，请按以下格式分析：
    1.建议投资中国某行业的股票/基金，理由是...
    2.建议投资美国某行业的股票/基金，理由是...
    3.人民币与美元的汇率分析结果：...
    
重要要求：
    1. 根据中国财经新闻，分析出中国股票/基金投资建议
    2. 根据美国财经新闻，分析出美国股票/基金投资建议
    3. 如果新闻没有提及汇率，请输出"没有关于汇率的可参考消息"
